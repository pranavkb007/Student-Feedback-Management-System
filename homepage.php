  ...
  <body>
    ...
    <form action="faculty_login.php" method="POST">
      <div class="faculty-login">
          <input type="submit" name="faculty" value="Faculty" id="faculty"/>
      </div>
    </form>
    ...
    <div class="container">
      ...
      <form action="php/feedback.php" method="post" class="student-form">
        ...
        <div class="student-details">
          ...
          <input type="text" name="name1" id="name1" placeholder="Enter Name"><br>
          <h4 class="head">
            Enter Your Seat no:
          </h4>
          <input type="number" name="rNo" id="rNo" placeholder="Seat Number"><br>
          <h4 class="head">
            Enter Your PRN no:
          </h4>
          <input type="text" name="prnNo" id="prnNo" placeholder="PRN number"><br><br>
        ...
        <div class="student-feedback">
          ...
          <!-- Question 5 -->
          <h4>5) Any Remarks</h4>
          <textarea name="remarks" rows="5" id="textarea"></textarea>
          <br /><br />
        </div>
